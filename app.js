$("document").ready(function () {
  ...
  const serverURL = "https://angularjs-ide-server.vercel.app";
  ...
  $("#btnSave").click(function (event) {
    ...
    $("#btnRun").click();
    const output = getOutput();
    let formattedOutput = style_html(output);
    download("index.html", formattedOutput);
  });
});
